...
public class Kingdom {
	...
	public Kingdom(String name){
		this.name = name;
		kingdom = new File("./plugins/HumineKingdomV2/Kingdom/"+name);
		kingdom.mkdirs();
		member = new File("./plugins/HumineKingdomV2/Kingdom/"+name+"/member.yml");
		if(!member.exists()){
			try{
	...
	public boolean haveDragonEgg(){
		File dragon = new File("./plugins/HumineKingdomV2/Kingdom/"+name+"/megakingdom.check");
		if(dragon.exists())
			return true;
