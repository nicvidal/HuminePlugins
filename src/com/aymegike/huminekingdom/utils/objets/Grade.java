...
public class Grade {
	...
	public Grade(String name, Kingdom kingdom, boolean registerindata){
		...
		new File("./plugins/HumineKingdomV2/Kingdom/"+kingdom.getName()+"/grade/"+name+"/").mkdirs();
		permFile = new File("./plugins/HumineKingdomV2/Kingdom/"+kingdom.getName()+"/grade/"+name+"/perms.yml");
		memberFile = new File("./plugins/HumineKingdomV2/Kingdom/"+kingdom.getName()+"/grade/"+name+"/member.yml");
		if(registerindata == true){
			try(PrintWriter print = new PrintWriter(new FileOutputStream(new File("./plugins/HumineKingdomV2/DATA/grade.yml"), true))){
	...
	public void delete() {
		...
		new File("./plugins/HumineKingdomV2/Kingdom/"+kingdom.getName()+"/grade/"+name+"/").delete();
		update();
