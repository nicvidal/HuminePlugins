...
public class HumineKingdom extends JavaPlugin{
	...
	public void onDisable(){
		...
		File file = new File("./plugins/HumineKingdomV2/config.yml");
		file.delete();
		if(!file.exists()){
			try{
				file.createNewFile();
	...
	public void loadAllFiles(){
		...
		new File("./plugins/HumineKingdomV2/DATA/").mkdirs();//generate Folder
		new File("./plugins/HumineKingdomV2/Kingdom/").mkdirs();//generate folder
		
		grade = new File("./plugins/HumineKingdomV2/DATA/grade.yml");//generate listGrade File
		kingdom = new File("./plugins/HumineKingdomV2/DATA/kingdom.yml");//generate listKingdom File
		zone = new File("./plugins/HumineKingdomV2/DATA/zone.yml");//generate listZoneFile
		...
		File file = new File("./plugins/HumineKingdomV2/config.yml");
		new File("./plugins/HumineKingdomV2").mkdirs();
