...
public class MenuUtils {
	...
	public static Menu openMenuJoin(Player sender, Player target){
		
		Menu menu = new Menu(sender.getName()+ChatColor.DARK_PURPLE+" souhaite ce joindre a toi !", 3*9);
	...
	public static Menu Welcome(Player player){
		
		Menu menu = new Menu(ChatColor.DARK_PURPLE+"Bienvenue "+ChatColor.WHITE+player.getName()+ChatColor.DARK_PURPLE+" sur "+ChatColor.WHITE+" HumineCraft", 3*9);
		...
		emeraldM.setDisplayName(ChatColor.GREEN+"INFORMATION !");
		lore.add(ChatColor.DARK_PURPLE+"Afin de devenir plus puissant, vous");
		lore.add(ChatColor.DARK_PURPLE+"pouvez créer ou rejoindre un royaume");
		lore.add(ChatColor.DARK_PURPLE+"et dominer le monde de "+ChatColor.WHITE+"HumineCraft"+ChatColor.DARK_PURPLE+" !");
		emeraldM.setLore(lore);
		emerald.setItemMeta(emeraldM);
		
		lore.clear();
		lore.add("");
		lore.add(ChatColor.RED+""+ChatColor.BOLD+"Vous ne pourez plus revenir");
		lore.add(ChatColor.RED+""+ChatColor.BOLD+"en arrière !");
		lore.add(ChatColor.DARK_PURPLE+""+ChatColor.ITALIC+"Cliquez pour valider");
		
		ItemStack accept = new ItemStack(Material.TOTEM);
		ItemMeta acceptm = accept.getItemMeta();
		acceptm.setDisplayName(ChatColor.GREEN+"rejoindre un(e) ami(e)");
		acceptm.setLore(lore);
		accept.setItemMeta(acceptm);
		
		ItemStack decline = new ItemStack(Material.IRON_SWORD);
		ItemMeta declineM = decline.getItemMeta();
		declineM.setDisplayName(ChatColor.WHITE+"Commencer seul");
		declineM.setLore(lore);
		decline.setItemMeta(declineM);
		...
		menu.addItem(emerald, 13);
		menu.addItem(accept, 16);
		menu.addItem(decline, 10);
