 ...
 */
function huminecraft_theme_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'huminecraft_theme_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.huminecraft_theme-front-page) .entry-title,
...
.colors-custom .huminecraft_theme-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.huminecraft_theme-front-page .panel-content .recent-posts article,
...
.colors-custom.huminecraft_theme-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'huminecraft_theme_custom_colors_css', $css, $hue, $saturation );
}
